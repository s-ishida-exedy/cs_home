<%@ Page Language="VB" AutoEventWireup="false" CodeFile="m_booking_colorkbn_detail.aspx.vb" Inherits="cs_home" %>
...
<title>ポータルサイト(ブッキングシート色区分詳細)</title>
...
<div id="contents2" class="inner2">
    <table class="header-ta" >
        <tr>
            ...
            <td class="third-cell">
                <a href="./m_booking_colorkbn.aspx">一覧に戻る</a>
            </td>
        </tr>
    </table>
