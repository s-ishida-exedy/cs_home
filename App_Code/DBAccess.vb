...
Public Class DBAccess
    ...
    Public Function GET_BOOKING_DATA(strSts As String, strFwd As String, strCust As String, strIV As String) As DataSet
        ...
        StrSQL = StrSQL & "  , a.Forwarder "
        StrSQL = StrSQL & "  , a.CUST_CD  "
        StrSQL = StrSQL & "  , a.CONSIGNEE "
        StrSQL = StrSQL & "  , a.DESTINATION "
        StrSQL = StrSQL & "  , a.INVOICE_NO  "
        StrSQL = StrSQL & "  , a.CUT_DATE "
        StrSQL = StrSQL & "  , a.ETD "
        StrSQL = StrSQL & "  , a.ETA "
        StrSQL = StrSQL & "  , a.TWENTY_FEET "
        StrSQL = StrSQL & "  , a.FOURTY_FEET "
        StrSQL = StrSQL & "  , a.LCL_QTY "
        StrSQL = StrSQL & "  , a.BOOKING_NO "
        StrSQL = StrSQL & "  , a.VESSEL_NAME "
        StrSQL = StrSQL & "  , a.VOYAGE_NO "
        ...
        StrSQL = StrSQL & "	ON a.CUST_CD = TBL.CUST_CD AND a.INVOICE_NO = TBL.INVOICE_NO "
        StrSQL = StrSQL & "WHERE a.STATUS like @STATUS "
        StrSQL = StrSQL & "AND   a.Forwarder like @Forwarder "
        StrSQL = StrSQL & "AND   a.CUST_CD like @CUST_CD "
        StrSQL = StrSQL & "AND   a.INVOICE_NO like @INVOICE_NO "
        StrSQL = StrSQL & "GROUP BY  "
    ...
    Public Function GET_CS_RESULT_MAIL(strValue As String) As DataSet
        'AIR専用客先　SN明細取得
        Conn = Me.Dbconnect
        Cmd = Conn.CreateCommand
        ...
        StrSQL = StrSQL & ""
        StrSQL = StrSQL & "SELECT "
        StrSQL = StrSQL & "  M_EXL_MAIL00.TASK_CD "
