...
Partial Class cs_home
    ...
    Private Sub GridView1_RowCreated(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim dltlink As LinkButton = e.Row.FindControl("LinkButton1")
            'ボタンが存在する場合のみセット
            If Not (dltlink Is Nothing) Then
                dltlink.CommandArgument = e.Row.RowIndex.ToString()
            End If

            If e.Row.Cells(4).Text = 0 Then
                e.Row.Cells(4).Text = "無効"
                e.Row.BackColor = Drawing.Color.LightGray
                e.Row.ForeColor = Drawing.Color.DarkGray
            ElseIf e.Row.Cells(4).Text = 1 Then
                e.Row.Cells(4).Text = "有効"
            End If
    ...
    Private Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        If e.CommandName = "edt" Then
            ...
            Session("strflg") = data4
            Response.Redirect("m_work00_detail.aspx")
        End If
