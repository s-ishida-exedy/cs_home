<%@ Page Language="VB" AutoEventWireup="false" CodeFile="booking_situation.aspx.vb" Inherits="cs_home" %>
    ...
    <table class="auto-style1" >
        <tr>
            <td class="auto-style4">
                <asp:Label ID="Label3" runat="server" Text="【コンテナ確保状況】" ></asp:Label>    
            </td>
