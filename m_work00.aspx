<%@ Page Language="VB" AutoEventWireup="false" CodeFile="m_work00.aspx.vb" Inherits="cs_home" %>
...
<tbody>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="3px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black"  ShowHeaderWhenEmpty="True">
<%--        <AlternatingRowStyle BackColor="White" />--%>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TASK_CD" HeaderText="ID" ReadOnly="True" SortExpression="TASK_CD" InsertVisible="False" >
            ...
            <HeaderStyle BackColor="#6B696B" Width="800px" />
...
<%--            <asp:TemplateField ShowHeader="False" HeaderText="リンク">
                <HeaderStyle Width="10px" />
                <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server"  CommandName="move">対象ページへ移動</asp:LinkButton>
　　　　　　　　　　</ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
                <HeaderStyle BackColor="#6B696B" />
            </asp:TemplateField>--%>
...
<%--        <FooterStyle BackColor="#CCCC99" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EXPDBConnectionString %>" SelectCommand="SELECT TASK_CD,TASK_NM,REF,VALIDFLG FROM [M_EXL_MAIL00] WHERE TASK_CD <> 0"></asp:SqlDataSource>
