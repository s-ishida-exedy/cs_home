<%@ Page Language="VB" AutoEventWireup="false" CodeFile="air_exclusive_a.aspx.vb" Inherits="cs_home"EnableEventValidation="false" %>
...
<title>ポータルサイト(AIR専用客先オーダー一括登録)</title>
...
<div id="contents2" class="inner2">
    <table class="header-ta" >
        <tr>
            <td class="first-cell">
                <h2>AIR専用客先オーダー一括登録</h2>  
            </td>
            <td class="second-cell">
                <asp:Label ID="Label12" runat="server" Text="" Class="err"></asp:Label>
                <br/>
                ※一括登録のみ。編集は「<a href="./air_exclusive.aspx">AIR専用客先オーダー確認</a>」
                &nbsp;&nbsp;
...
<div class="right">
    <table class="header-ta2" >
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="まとめて登録" width="200px" Font-Size="Small" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="客先CD　："></asp:Label>&nbsp;
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label4" runat="server" Text="ＥＴＤ　 ："></asp:Label>&nbsp;
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label6" runat="server" Text="ｲﾝﾎﾞｲｽNO："></asp:Label>&nbsp;
            </td>
            <td>
...
<!--/#contents2-->
    <asp:TextBox ID="TextBox13" runat="server" Class="txtc" ></asp:TextBox>
