...
Partial Class cs_home
    ...
    Private Sub form1_Load(sender As Object, e As EventArgs) Handles form1.Load
        If IsPostBack Then
            ' そうでない時処理
        Else
            Me.DropDownList1.Items.Insert(0, "-協定-") '先頭に空白行追加
        End If
    ...
    Private Sub Make_Grid()
        ...
        If strVal = "-協定-" Then
            strVal = ""
        End If
        Dim strItmCd As String = Trim(TextBox1.Text)
        Dim strItmNm As String = Trim(TextBox2.Text)
        Dim strOriNo As String = Trim(TextBox3.Text)

        'データの取得
        Dim ds As DataSet = Dataobj.GET_RESULT_EPA_ITEM(strVal, strItmCd, strItmNm, strOriNo)
    ...
    Private Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        If e.CommandName = "edt" Then
            ...
            Response.Redirect("m_epa_itm_detail.aspx")
        End If
