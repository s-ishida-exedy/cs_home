...
<div id="contents2" class="inner2">
    <table>
        <tr>
            <td  width="400">
                ...
                <asp:Label ID="Label3" runat="server" Text="特定輸出管理表" ></asp:Label>   
      </font>
 ...
 <%--               <asp:Label ID="Label4" runat="server" Text="客先CD："></asp:Label>
                ...
                <asp:Button ID="Button1" runat="server" Text="委託登録" />&nbsp;
                <asp:Button ID="Button2" runat="server" Text="キャンセル登録" />
            </td>

            <td  width="100">
                        <font size="2"  >
<a href="cs_declearkannrihyou_all.aspx?id={0}" class="simple_square_btn4">履歴へ<span></span></a>
</section>
            </td>
