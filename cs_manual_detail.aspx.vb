...
Partial Class cs_home
    ...
    Private Sub DB_access()
        ...
        If strMode = "01" Then
            ...
            strSQL = strSQL & "SET "
            strSQL = strSQL & "  OLD_CODE =  '" & LTrim(RTrim(TextBox2.Text)) & "' "
            strSQL = strSQL & "  , CUST_NM =  '" & LTrim(RTrim(TextBox3.Text)) & "' "
            strSQL = strSQL & "  , CUST_AB =  '" & LTrim(RTrim(TextBox4.Text)) & "' "
            strSQL = strSQL & "  , INCOTEM =  '" & LTrim(RTrim(TextBox5.Text)) & "' "
            strSQL = strSQL & "  , BL_TYPE =  '" & LTrim(RTrim(TextBox6.Text)) & "' "
            strSQL = strSQL & "  , BL_SEND =  '" & LTrim(RTrim(TextBox7.Text)) & "' "
            strSQL = strSQL & "  , CUST_ADDRESS =  '" & LTrim(RTrim(TextBox8.Text)) & "' "
            strSQL = strSQL & "  , CONSIGNEE =  '" & LTrim(RTrim(TextBox55.Text)) & "' "
            strSQL = strSQL & "  , CNEE_NM_SI =  '" & LTrim(RTrim(TextBox9.Text)) & "' "
            strSQL = strSQL & "  , FIN_DESTINATION =  '" & LTrim(RTrim(TextBox10.Text)) & "' "
            strSQL = strSQL & "  , NOTIFY =  '" & LTrim(RTrim(TextBox11.Text)) & "' "
            strSQL = strSQL & "  , FORWARDER_INFO =  '" & LTrim(RTrim(TextBox12.Text)) & "' "
            strSQL = strSQL & "  , CUST_REQ =  '" & LTrim(RTrim(TextBox13.Text)) & "' "
            ...
            strSQL = strSQL & "  , SALES_STAFF =  '" & LTrim(RTrim(TextBox14.Text)) & "' "
            strSQL = strSQL & "  , SALES_STAFF1 =  '" & LTrim(RTrim(TextBox15.Text)) & "' "
            strSQL = strSQL & "  , SALES_STAFF2 =  '" & LTrim(RTrim(TextBox16.Text)) & "' "
            strSQL = strSQL & "  , SALES_STAFF3 =  '" & LTrim(RTrim(TextBox17.Text)) & "' "
            strSQL = strSQL & "  , SALES_STAFF4 =  '" & LTrim(RTrim(TextBox18.Text)) & "' "
            strSQL = strSQL & "  , CUST_STAFF =  '" & LTrim(RTrim(TextBox19.Text)) & "' "
            strSQL = strSQL & "  , CUST_STAFF1 =  '" & LTrim(RTrim(TextBox20.Text)) & "' "
            strSQL = strSQL & "  , CUST_STAFF2 =  '" & LTrim(RTrim(TextBox21.Text)) & "' "
            strSQL = strSQL & "  , CUST_STAFF3 =  '" & LTrim(RTrim(TextBox22.Text)) & "' "
            strSQL = strSQL & "  , CUST_STAFF4 =  '" & LTrim(RTrim(TextBox23.Text)) & "' "
            strSQL = strSQL & "  , SHIP_DAY_OF_WEEK =  '" & LTrim(RTrim(TextBox24.Text)) & "' "
            strSQL = strSQL & "  , DESTINATION =  '" & LTrim(RTrim(TextBox25.Text)) & "' "
            strSQL = strSQL & "  , SHIPMENT_KBN =  '" & LTrim(RTrim(TextBox26.Text)) & "' "
            strSQL = strSQL & "  , LT =  '" & LTrim(RTrim(TextBox27.Text)) & "' "
            strSQL = strSQL & "  , PORT =  '" & LTrim(RTrim(TextBox28.Text)) & "' "
            strSQL = strSQL & "  , SHIP_AGREE =  '" & LTrim(RTrim(TextBox29.Text)) & "' "
            strSQL = strSQL & "  , SHIPPING_COMPANY =  '" & LTrim(RTrim(TextBox30.Text)) & "' "
            strSQL = strSQL & "  , LOCAL_AGENCY =  '" & LTrim(RTrim(TextBox31.Text)) & "' "
            strSQL = strSQL & "  , CONTAINER_SIZE =  '" & LTrim(RTrim(TextBox32.Text)) & "' "
            strSQL = strSQL & "  , REMARKS_ONBL =  '" & LTrim(RTrim(TextBox33.Text)) & "' "
            strSQL = strSQL & "  , IV_ON_BL =  '" & LTrim(RTrim(TextBox34.Text)) & "' "
            strSQL = strSQL & "  , HS_ON_BL =  '" & LTrim(RTrim(TextBox56.Text)) & "' "
            strSQL = strSQL & "  , CNEE_STAFF =  '" & LTrim(RTrim(TextBox35.Text)) & "' "
            strSQL = strSQL & "  , CNEE_STAFF_CONTACT1 =  '" & LTrim(RTrim(TextBox36.Text)) & "' "
            strSQL = strSQL & "  , CNEE_STAFF_CONTACT2 =  '" & LTrim(RTrim(TextBox37.Text)) & "' "
            strSQL = strSQL & "  , CNEE_STAFF2 =  '" & LTrim(RTrim(TextBox38.Text)) & "' "
            strSQL = strSQL & "  , CNEE_STAFF2_CONTACT =  '" & LTrim(RTrim(TextBox39.Text)) & "' "
            strSQL = strSQL & "  , TAXID =  '" & LTrim(RTrim(TextBox40.Text)) & "' "
            strSQL = strSQL & "  , CONTAINER_CLEANING =  '" & DropDownList11.SelectedValue & "' "
            strSQL = strSQL & "  , LC =  '" & DropDownList12.SelectedValue & "' "
            strSQL = strSQL & "  , CONSIGNEE_OF_SI =  '" & LTrim(RTrim(TextBox41.Text)) & "' "
            strSQL = strSQL & "  , CONSIGNEE_OF_SI_ADDRESS =  '" & LTrim(RTrim(TextBox42.Text)) & "' "
            strSQL = strSQL & "  , FINAL_DES =  '" & LTrim(RTrim(TextBox43.Text)) & "' "
            strSQL = strSQL & "  , FINAL_DES_ADDRESS =  '" & LTrim(RTrim(TextBox44.Text)) & "' "
            strSQL = strSQL & "  , BEARING =  '" & LTrim(RTrim(TextBox45.Text)) & "' "
            strSQL = strSQL & "  , IV_AUTO_CALC =  '" & LTrim(RTrim(TextBox46.Text)) & "' "
            strSQL = strSQL & "  , FORWARDER =  '" & LTrim(RTrim(TextBox47.Text)) & "' "
            strSQL = strSQL & "  , FORWARDER_STAFF =  '" & LTrim(RTrim(TextBox48.Text)) & "' "
            strSQL = strSQL & "  , TO1 =  '" & LTrim(RTrim(TextBox49.Text)) & "' "
            strSQL = strSQL & "  , CC1 =  '" & LTrim(RTrim(TextBox50.Text)) & "' "
            strSQL = strSQL & "  , CC2 =  '" & LTrim(RTrim(TextBox51.Text)) & "' "
            strSQL = strSQL & "  , CC3 =  '" & LTrim(RTrim(TextBox52.Text)) & "' "
            strSQL = strSQL & "  , FORWARDER_NM =  '" & LTrim(RTrim(TextBox53.Text)) & "' "
            strSQL = strSQL & "  , FORWARDER_STAFF_NM =  '" & LTrim(RTrim(TextBox54.Text)) & "' "
