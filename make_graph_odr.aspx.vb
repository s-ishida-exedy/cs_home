...
Partial Class yuusen
    ...
    Public Shared Function getTrafficSourceData() As List(Of trafficSourceData)
        ...
        Using cn As SqlConnection = New SqlConnection("Data Source=kbhwpm02;Initial Catalog=EXPDB;User Id=sa;Password=expdb-manager")
            Dim myQuery As String = "select ETD,SHEPPED,UNSHEPPED,AVER,MAX from T_EXL_GRAPH_ODRNO "
            ...
            If dr.HasRows Then
                ...
                While dr.Read()
                    ...
                    tsData.value = dr("SHEPPED").ToString()
                    tsData.label = dr("ETD").ToString()
                    tsData.value2 = dr("UNSHEPPED").ToString()
                    tsData.value3 = dr("AVER").ToString()
                    tsData.value4 = dr("MAX").ToString()
