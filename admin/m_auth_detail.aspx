<%@ Page Language="VB" AutoEventWireup="false" CodeFile="m_auth_detail.aspx.vb" Inherits="cs_home" %>
...
<div id="main2" style="width:100%; height:450px;border:None;">
    <table class="ta3">
        ...
        <tr>
            <th>権限</th>
            <td>
                <asp:CheckBox ID="CheckBox1" runat="server" text="：admin（管理者）" />
                <asp:CheckBox ID="CheckBox2" runat="server" text="：csusr（CSメンバー）" />
                <asp:CheckBox ID="CheckBox3" runat="server" text="：usr（その他）" />
            </td>
        </tr>
    </table>
</div>
