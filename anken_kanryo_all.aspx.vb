...
Partial Class yuusen
    ...
    Private Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        If e.CommandName = "edt" Then
            ...
            Else
                ...
                If a > 0 Then
                    If data9 = 1 Then
                        Call Mail02(data1, data2, data3, data4, data5, data6, data7)
                    Else
                    End If
    ...
    Private Sub form1_Load(sender As Object, e As EventArgs) Handles form1.Load
        ...
        For I = 0 To GridView1.Rows.Count - 1
            ...
            If GridView1.Rows(I).Cells(5).Text <> "〇" Then
                'dltButton2.Visible = False
    ...
    Private Sub reg_check3(bkgno As String, A As String, ByRef dflg As Long, nom As String, kanflg As String)
        ...
        ElseIf A = "3" Then 'KD
            ...
            If kanflg = 1 Then
                ...
                Call reg_kanryo4(strinv, bkgno, dflg)
            Else
                Call reg_kanryo4(strinv, bkgno, dflg)
            End If
        End If
    ...
    Private Sub reg_kanryo4(strinv As String, bkgno As String, ByRef dflg As Long)
        '接続文字列の作成
        Dim ConnectionString As String = String.Empty
        'SQL Server認証
        ConnectionString = "Data Source=KBHWPM02;Initial Catalog=EXPDB;User Id=sa;Password=expdb-manager"
    ...
    Private Sub check004(strinv As String, bkgno As String, eflg As Long, strcst As String)
        ...
        If getflg01 = 1 And getflg02 = 1 Then
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str計上日01 & vbLf & "I:" & str計上日02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str積出港01 & vbLf & "I:" & str積出港02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str揚地01 & vbLf & "I:" & str揚地02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str配送先01 & vbLf & "I:" & str配送先02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str荷受地01 & vbLf & "I:" & str荷受地02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & strカット日01 & vbLf & "I:" & strカット日02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str到着日01 & vbLf & "I:" & str到着日02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str入出港日01 & vbLf & "I:" & str入出港日02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & strVOYAGENo01 & vbLf & "I:" & strVOYAGENo02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str船社01 & vbLf & "I:" & str船社02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & strブッキングNo01 & vbLf & "I:" & strブッキングNo02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "B:" & str船名01 & vbLf & "I:" & str船名02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "M:" & strFINALDN01 & vbLf & "I:" & strFINALDN02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "M:" & strFINALDA01 & vbLf & "I:" & strFINALDA02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "M:" & strCNEESIN01 & vbLf & "I:" & strCNEESIN02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "M:" & strCNEESIA01 & vbLf & "I:" & strCNEESIA02
            ...
            Else
                errlrmsg02 = "×" & vbLf & "M:" & strNOTYSI01 & vbLf & "I:" & strNOTYSI02
        ...
        ElseIf getflg01 = 1 And getflg02 = 0 Then
            errlrmsg01 = "1:イントラなし" '"イントラなし"
        ElseIf getflg01 = 0 And getflg02 = 1 Then
            errlrmsg01 = "1:Bookingシートなし" '"Bookingシートなし"
        ElseIf getflg01 = 0 And getflg02 = 0 Then
            errlrmsg01 = "1:両方なし" '"両方なし"
        End If
    ...
    Private Sub erreg(ByRef a As Long, ByRef bkgno As String)
    ...
    Sub Mail01(ByRef bkgno As String, ByRef a As String, ByRef b As String, ByRef c2 As String, ByRef d As String, ByRef e As String, ByRef f As String, ByRef g As String)
        ...
        Else
            stritk = " 委託案件"
            subject = subject & "★" & stritk
        End If

        body = body & "＜ コンテナ" & strcon & "/" & e & "本目(ブッキングシートがただしければ)" & stritk & " ＞<br/>"


        t = "<html><body><Table border='1' style='Font-Size:13px;font-family:Meiryo UI;'><tr style='background-color: #6fbfd1;'><td>IVNO</td><td>通貨</td><td>レート</td><td>客先</td><td>LS7.9</td><td>LS7.9品名</td><td>木材</td></tr>"
    ...
    Sub Mail03(ByRef bkgno As String, ByRef a As String, ByRef b As String, ByRef c2 As String, ByRef d As String, ByRef e As String, ByRef f As String, ByRef g As String)
        ...
        t = "<html><body><Table border='1' style='Font-Size:13px;font-family:Meiryo UI;'><tr style='background-color: #6fbfd1;'><td>IVNO</td><td>通貨</td><td>レート</td><td>客先</td><td>LS7.9</td><td>品名</td><td>木材</td></tr>"
    ...
    Sub Mail02(ByRef bkgno As String, ByRef a As String, ByRef b As String, ByRef c2 As String, ByRef d As String, ByRef e As String, ByRef f As String)
        ...
        'メールの件名
        Dim subject As String = " 【通知】エラー" & "　最終バン：" & a & " " & b & "　客先：" & c2 & "　IV-" & d & "　コンテナ：" & e & " 本" & "　ETD：" & f
        'message.Subject = ConvertBase64Subject(System.Text.Encoding.GetEncoding("csISO2022JP"), _MailTitle)
        ...
        body = body & "<html><body>CS各位<br>お疲れ様です。<br><br>エラーが発生しているため、ご確認宜しくお願いいたします。<br><br><br>＜説明＞<br>B　：　Booking sheet　　　　 I　：　Intra-mart<br><br><br><エラー内容></body></html>" ' UriBodyC()
    ...
    Private Sub IVINFO2(bkgno As String, IVNO As String, ByRef t As String)
        ...
        strSQL = "SELECT DISTINCT T_INV_BD_TB.LS, T_INV_BD_TB.PRODNAME "
        strSQL = strSQL & "FROM T_INV_HD_TB LEFT JOIN T_INV_BD_TB ON T_INV_HD_TB.INVOICENO = T_INV_BD_TB.INVOICENO "
        ...
        While (dataread.Read())
            ...
            strcst = Trim(Convert.ToString(dataread("PRODNAME")))        '客先目
            't = t & "<td>" & strinv & "</td><td> " & strcst & "</td><td> " & strcst & "</td>"
            t = t & "<td>" & "11111" & "</td><td>" & "11111" & "</td><td>" & "11111" & "</td>"
        End While
    ...
    Private Sub GETERROR(bkgno As String, ByRef t As String)
        ...
        While (dataread.Read())
            ...
            t = t & "<br>" & "・IV-" & strinv & " エラー項目:" & strrate2 & " エラー内容:" & strrate
        End While
