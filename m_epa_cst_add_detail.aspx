<%@ Page Language="VB" AutoEventWireup="false" CodeFile="m_epa_cst_add_detail.aspx.vb" Inherits="cs_home" %>
...
<title>ポータルサイト(EPA客先住所ﾏｽﾀ詳細)</title>
...
<div id="main2" style="width:100%; height:450px;border:None;">
        <table class="ta3">
            ...
            <tr>
                <th>客先住所</th>
                <td>
                    <asp:TextBox ID="TextBox3" runat="server" Height="50px" Width="450px" TextMode="MultiLine" Class ="txtb"></asp:TextBox>
                </td>
            </tr>
