<%@ Page Language="VB" AutoEventWireup="false" CodeFile="m_kaika_jpn_eg_detail.aspx.vb" Inherits="cs_home" %>
...
<title>ポータルサイト(海貨御者日本語名・英語名変換詳細)</title>
...
<div id="contents2" class="inner2">
    <table class="header-ta" >
        <tr>
            ...
            <td class="third-cell">
                <a href="./m_kaika_jpn_eg.aspx">一覧に戻る</a>
            </td>
        </tr>
    </table>
